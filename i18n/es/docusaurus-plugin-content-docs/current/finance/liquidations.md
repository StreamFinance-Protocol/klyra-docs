...
- Priorización de Liquidaciones: Las liquidaciones tienen prioridad sobre las transacciones estándar del libro de órdenes para asegurar que las cuentas insalubres sean atendidas rápidamente.
